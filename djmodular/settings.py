"""
Django settings for djmodular project.
...
MIDDLEWARE = [
    ...
    # Custom middleware
    'modular_engine.middleware.URLPatternSyncMiddleware',
...
WSGI_APPLICATION = 'djmodular.wsgi.application'
...
# Use Redis for caching if REDIS_URL is set (in Docker)
